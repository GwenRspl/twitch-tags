...
export class TagsService {
  ...
  private defaultPath = 'https://twitch-tags.herokuapp.com/api/tags/';
  private getByNamePath = 'https://twitch-tags.herokuapp.com/api/tags/search-by-name/';
  private existencePath = this.defaultPath + 'is-present/';
  private createPath = this.defaultPath + 'create/';
  private linkTagChannelPath = 'https://twitch-tags.herokuapp.com/api/channel-tag-user-link/create';
